...
class HTPA:
	...
	def measure_observed_offset(self):
		print("Ukur objek yang diamati")
		print("Kamera harus terhadap permukaan suhu yang seragam")
	...
	def capture_image(self, blind=False):
		...
		for block in range(4):
			...
			# data dasar adalah dalam proses pembentukan
	...
	def send_command(self, cmd, wait=True):
		...
		if wait:
			time.sleep(0.005) # jeda untuk 5 ms
